...
public class RboDemo {
    private static Logger logger = LoggerFactory.getLogger(RboDemo.class);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            RexBuilder rexBuilder = CalciteUtils.createRexBuilder(factory);
            ...
            // SqlNode toRelNode
            SqlToRelConverter sqlToRelConverter = new SqlToRelConverter(new CalciteUtils.ViewExpanderImpl(),
